...
export default function HustlerSignup() {
  ...
  if (loading) {
    return <LoadingScreen text="Creating your hustler account..." />;
  }
    ...
    <div className="relative min-h-screen w-full flex flex-row justify-center pt-14 pb-14 px-6 sm:px-10 bg-[#FAFAFA] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-[0.04] sm:opacity-[0.05] select-none z-0">
        <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <pattern id="honeycomb-hustler" width="56" height="97" patternUnits="userSpaceOnUse" patternTransform="scale(0.85)">
          ...
          <rect width="100%" height="100%" fill="url(#honeycomb-hustler)" />
        </svg>
      </div>
